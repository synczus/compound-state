...
SOURCES = {
    ...
    "a16z-crypto": {
        "name": "a16z-crypto",
        "rss_url": "https://a16zcrypto.substack.com/feed",
        "baseline": 0.86,
        "keyword_tags": ["CRYPTO", "AI", "DEFI", "WEB3"],
        "event_type": "crypto_analysis",
        "cron_schedule": "0 */4 * * *",
    },
    "coinstack": {
        "name": "coinstack",
        "rss_url": "https://coinstack.substack.com/feed",
        "baseline": 0.80,
        "keyword_tags": ["CRYPTO", "BTC", "ETH", "REGULATION", "DEFI"],
        "event_type": "crypto_roundup",
        "cron_schedule": "0 */4 * * *",
    },
    "the-tech-buzz": {
        "name": "the-tech-buzz",
        "rss_url": "https://thetechbuzz.substack.com/feed",
        "baseline": 0.74,
        "keyword_tags": ["AI", "BIGTECH", "INVESTING"],
        "event_type": "tech_investing",
        "cron_schedule": "0 */4 * * *",
    },
    "hacker-news": {
        "name": "hacker-news",
        "rss_url": "https://hnrss.org/frontpage?count=25",
        "baseline": 0.30,
        "keyword_tags": ["AI", "STARTUP", "VC", "TECH"],
        "event_type": "tech_trending",
        "cron_schedule": "0 */2 * * *",
    },
    "arxiv-ai": {
        "name": "arxiv-ai",
        ...
        "baseline": 0.35,
        "keyword_tags": ["AI", "ML", "LLM", "DEEPLEARNING", "AGENT"],
        "event_type": "ai_research",
        "cron_schedule": "0 */4 * * *",
    },
    "bankless": {
        "name": "bankless",
        "rss_url": "https://www.bankless.com/feed",
        "baseline": 0.65,
        "keyword_tags": ["CRYPTO", "ETH", "DEFI", "WEB3"],
        "event_type": "crypto_narrative",
        "cron_schedule": "0 */4 * * *",
    },
}
